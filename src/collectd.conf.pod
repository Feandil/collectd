...
=item B<LogicalCPUNames> I<true>|I<false>

Boolean enabling the use of logical processor numbering for per core statistics
When enabled, C<cpuE<lt>nE<gt>> is used as plugin instance, where I<n> is the
